/**
 * apps/vfs.js - Sovereign File System Core Drivers
 * Optimized with Connection Pooling and Transaction Safety
 */
export const SovereignVFS = {
    DB_NAME: "SovereignCore_VFS",
    STORE_NAME: "vault",
    _db: null, // Connection Cache
    ...
    async deriveKey(password, memberId) {
        console.log("VFS: Generating Enclave Key...");
    ...
    async read(path, key) {
        if (!key) throw new Error("VFS: No encryption key provided.");
        const db = await this.init();
        ...
        return new Promise((resolve, reject) => {
            ...
            request.onsuccess = async () => {
                ...
                try {
                    ...
                    reject("Decryption failed: Check password/key.");
                }
            };
...
// Global export for use in Files app and Kernel
window.SovereignVFS = SovereignVFS;