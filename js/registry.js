export const registry = [
    ...
    { id: 'thrive', name: 'Thrive Health', icon: '🌱', file: 'thrive.js' },
    { id: 'elevate', name: 'Innovation', icon: '💡', file: 'elevate.js' },
    { id: 'boost', name: 'TLC Boost', icon: '⚡', file: 'boost.js' },
    { id: 'impact', name: 'Impact Social', icon: '🌟', file: 'impact.js' },
